param(
    [string]$Out = 'E:\NewVersiongithub\githubeVersionMerge\Code\systemhesabdari\.freebuff\togglepersons.txt'
)
...
[void][Win32Tg]::SetForegroundWindow($proc.MainWindowHandle)
Start-Sleep -Milliseconds 400
[System.Windows.Forms.Cursor]::Position = New-Object System.Drawing.Point($x, $y)
Start-Sleep -Milliseconds 200
[Win32Tg]::mouse_event(0x0002, 0, 0, 0, [UIntPtr]::Zero)
Start-Sleep -Milliseconds 80
[Win32Tg]::mouse_event(0x0004, 0, 0, 0, [UIntPtr]::Zero)
Start-Sleep -Milliseconds 1500
$sb = New-Object System.Text.StringBuilder
[void]$sb.AppendLine("CLICK BtnPersons at=$x,$y")
...
for ($i=0; $i -lt $all2.Count; $i++) {
    $e = $all2.Item($i)
    if ($e.Current.Name -match 'لیست اشخاص|شخص جدید|حذف دسته') {
        [void]$sb.AppendLine("[$i] name='$($e.Current.Name)' id='$($e.Current.AutomationId)' off=$($e.Current.IsOffscreen) rect=$($e.Current.BoundingRectangle.X),$($e.Current.BoundingRectangle.Y)")
    }
}
