...
$script:inputReached = $false
$handler = [System.Windows.Automation.AutomationEventHandler]{
    param($s, $e)
    Set-Variable -Name inputReached -Value $true -Scope Script
}
[System.Windows.Automation.Automation]::AddAutomationEventHandler(
    [System.Windows.Automation.AutomationElement]::InputReachedTargetEvent,
    $tab,
...
[void][Win32Sync2]::SetForegroundWindow($hwnd)
Start-Sleep -Milliseconds 600
[System.Windows.Forms.Cursor]::Position = New-Object System.Drawing.Point($x, $y)
Start-Sleep -Milliseconds 400
[Win32Sync2]::mouse_event(0x0002, 0, 0, 0, [UIntPtr]::Zero)
Start-Sleep -Milliseconds 200
[Win32Sync2]::mouse_event(0x0004, 0, 0, 0, [UIntPtr]::Zero)
Start-Sleep -Milliseconds 3500

$sb = New-Object System.Text.StringBuilder
[void]$sb.AppendLine("INPUT_REACHED_TAB=$($script:inputReached)")
...
try { [System.Windows.Automation.Automation]::RemoveAutomationEventHandler([System.Windows.Automation.AutomationElement]::InputReachedTargetEvent, $tab, $handler) } catch {}
[IO.File]::WriteAllText('E:\NewVersiongithub\githubeVersionMerge\Code\systemhesabdari\.freebuff\sm2_sync2.txt', $sb.ToString(), (New-Object System.Text.UTF8Encoding($true)))
Write-Output "DONE"
