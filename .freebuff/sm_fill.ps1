...
Set-Field 'FirstNameInput' 'QA'
Set-Field 'LastNameInput' 'FinalTest'
Set-Field 'NationalCodeInput' '0499370899'

# move focus to Mobile field to trigger binding push
$mobile = $null
...
if ($mobile) {
    ...
    if ($r.Width -gt 0 -and $r.Height -gt 0) {
        ...
        [void][Win32Fill]::SetForegroundWindow($hwnd)
        Start-Sleep -Milliseconds 300
        [System.Windows.Forms.Cursor]::Position = New-Object System.Drawing.Point($x, $y)
        Start-Sleep -Milliseconds 150
        [Win32Fill]::mouse_event(0x0002, 0, 0, 0, [UIntPtr]::Zero)
        Start-Sleep -Milliseconds 60
        [Win32Fill]::mouse_event(0x0004, 0, 0, 0, [UIntPtr]::Zero)
        Write-Output "FOCUS_MOVED to MobileInput at=$x,$y"
    }
}
