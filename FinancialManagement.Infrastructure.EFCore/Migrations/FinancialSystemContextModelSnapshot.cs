...
{
    [DbContext(typeof(FinancialSystemContext))]
    partial class FinancialSystemContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinancialManagement.Domain.FundAgg.Funds", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FinancialManagement.Domain.PettyCashAgg.PettyCashes", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FinancialManagement.Domain.ReceiptsPaymentAgg.ReceiptsPayments", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FinancialManagement.Domain.PettyCashAgg.PettyCashes", b =>
                {
                    ...
                    b.HasOne("PersonManagement.Domain.Person.PersonAgg.Persons", "HolderPerson")
                        .WithMany()
                        .HasForeignKey("HolderPersonId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("PersonManagement.Domain.Person.PersonAgg.Persons", "ResponsiblePerson")
                        .WithMany()
                        .HasForeignKey("ResponsiblePersonId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("AccountManagement.Domain.Account.AccountAgg.Accounts", "SettlementAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("FinancialManagement.Domain.ReceiptsPaymentAgg.ReceiptsPayments", b =>
                {
                    ...
                    b.HasOne("FinancialManagement.Domain.FundAgg.Funds", "Funds")
                        .WithMany()
